...
const { getAllProducts, createProducts, updateProducts, deleteProduct, getProductDetail, createProductReview, getSinglProductReivew, deleteReview } = require('../controller/ProductController')
